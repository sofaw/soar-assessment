...
public class CustomerPasswordCallbackHandler implements CallbackHandler {
	...
	public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
		for(Callback callback : callbacks) {
			...
			try {
				...
				ResultSet rs = stmt.executeQuery("SELECT * FROM CUSTOMERS WHERE USERNAME=" + "\'" + wspc.getIdentifer() + "\'");
				if(rs.next()) {
